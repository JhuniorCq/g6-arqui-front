    ...
    <div className="dropdown">
      ...
      <ul className="dropdown-menu dropdown-menu-primary">
        {userOptions ? (
          <>
            <li>
              <Link to={ user.roles.includes("APPLICANT") ? "/": "/publicar-ofertas" } className="dropdown-item">Inicio</Link>
            </li>
            <li>
              <Link to={ user.roles.includes("APPLICANT") ? "/configuracion-postulante": "/configuracion-empresa" } className="dropdown-item">Configuración</Link>
            </li>
            <li>
